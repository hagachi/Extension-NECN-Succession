...
Source: {#BuildDir}\Landis.Extension.Succession.NECN-DAMM.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Succession.NECN-DAMM.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
