...
namespace Landis.Extension.Succession.NECN
{
    public class ReproductionLog
    {
        ...
        [DataFieldAttribute(Unit = FieldUnits.Count, Desc = "Number of Cohorts Established on Ground Surface")]
        public int NumCohortsSurface { set; get; }

        [DataFieldAttribute(Unit = FieldUnits.Count, Desc = "Number of Cohorts Established on Nursery Logs")]
        public int NumCohortsNlog { set; get; }
