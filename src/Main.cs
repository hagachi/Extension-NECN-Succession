                                       ...
                                       bool        isSuccessionTimeStep)
        {
            ...
            for (int y = 0; y < years; ++y) {
                ...
                for (MonthCnt = 0; MonthCnt < 12; MonthCnt++)
                {
                    ...
                    SiteVars.MonthlyStreamDON[site][Month] = 0.0;       // Chihiro; To input into soil water model
                    SiteVars.MonthlyStreamNitrate[site][Month] = 0.0;   // Chihiro; To input into soil water model
                    SiteVars.MonthlyAmtNLeached[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyWaterMovement[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyBaseFlow[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyStormFlow[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyPet[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyAvailableWater[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyLiquidSnowPack[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlySoilWaterContent[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyDecayFactor[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlySoilTemperature[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyXh2o[site][Month] = 0.0; // Chihiro
                    SiteVars.MonthlyAnaerobicEffect[site][Month] = 0.0; // Chihiro
